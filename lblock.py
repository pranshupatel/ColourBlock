        ...
        if self._snapshots == 1:
            try:
                ...
                if col > 0 and \
                        ...
                        and self.grid[row + 1][col - 2].get_colour() == self._default_colour \
                        and self.grid[row + 2][col - 1].get_colour() == self._default_colour:

                    self._nodes[1] = self.grid[row + 2][col - 1]
                    self._nodes[2] = self.grid[row + 1][col - 1]
            ...
            try:
                ...
                if self.grid[row + 1][col - 1].get_colour() == self._default_colour \
                    ...
                    self._nodes[1] = self.grid[row - 1][col - 2]
                    self._nodes[2] = self.grid[row - 1][col - 1]
                    self._nodes[3] = self.grid[row + 1][col - 1]
